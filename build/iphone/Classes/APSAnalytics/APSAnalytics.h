 ...
 * to send analytic data that can be viewed on the pushnotificationtest Dashboard.
 *
 * For information on getting started with pushnotificationtest Platform Services,
