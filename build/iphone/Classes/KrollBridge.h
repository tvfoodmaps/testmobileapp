...
@interface pushnotificationtestObject : KrollCoverageObject {
#else
@interface pushnotificationtestObject : KrollObject {
#endif
@private
...
extern NSString * pushnotificationtest$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	pushnotificationtestObject *_pushnotificationtest;
    KrollObject* console;
	BOOL shutdown;
