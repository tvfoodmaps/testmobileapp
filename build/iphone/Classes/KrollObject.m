...
//@interface pushnotificationtestObject : NSObject
//@end

@interface pushnotificationtestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pushnotificationtestObject class]])
		{
			for (NSString *key in [[(pushnotificationtestObject*)o modules] allKeys])
			{
