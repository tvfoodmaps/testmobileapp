...
// in simulator we redefine to format for pushnotificationtest Developer console
...
{\
	NSString * exceptionName = [@"org.pushnotificationtest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pushnotificationtest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpushnotificationtestNativeItemNone = -1, 
	UIpushnotificationtestNativeItemSpinner = -2,
	UIpushnotificationtestNativeItemProgressBar = -3,
	
	UIpushnotificationtestNativeItemSlider = -4,
	UIpushnotificationtestNativeItemSwitch = -5,
	UIpushnotificationtestNativeItemMultiButton = -6,
	UIpushnotificationtestNativeItemSegmented = -7,
	
	UIpushnotificationtestNativeItemTextView = -8,
	UIpushnotificationtestNativeItemTextField = -9,
	UIpushnotificationtestNativeItemSearchBar = -10,
	
	UIpushnotificationtestNativeItemPicker = -11,
	UIpushnotificationtestNativeItemDatePicker = -12,
	
	UIpushnotificationtestNativeItemInfoLight = -13,
	UIpushnotificationtestNativeItemInfoDark = -14,
	
	UIpushnotificationtestNativeItemDisclosure = -15,
	
	UIpushnotificationtestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all pushnotificationtest instances of
