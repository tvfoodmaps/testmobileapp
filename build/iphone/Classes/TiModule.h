...
/**
 The base class for all pushnotificationtest modules
 */
...
/**
 pushnotificationtest Platform calls this method on startup.
 */
-(void)startup;

/**
 pushnotificationtest Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 pushnotificationtest Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 pushnotificationtest Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 pushnotificationtest Platform calls this method on resume.
 @param sender The sender of the event.
 */
