...
//Rare exceptions to indicate a bug in the _pushnotificationtest code (Eg, function that a subclass should have implemented)
...
/**
 The base class for pushnotificationtest proxies.
 */
