...
/**
 Base class for all pushnotificationtest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the pushnotificationtest view hierarchy (such as wrapped iOS UIViews) was touched.
